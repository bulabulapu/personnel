...
public class DepartTransfer {
	...
	public int getDeTrId() {
		return deTrId;
	}

	public void setDeTrId(int deTrId) {
		this.deTrId = deTrId;
	}
	...
	public String toString() {
		return "DepartTransfer [deTrId=" + deTrId + ", staffId=" + staffId + ", newDepart=" + newDepart + ", oldDepart="
				+ oldDepart + ", deType=" + deType + ", deReson=" + deReson + ", deRemark=" + deRemark + ", deDate="
				+ deDate + "]";
	}
